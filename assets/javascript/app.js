...
$(document).ready(function() {
    ...
    $('text-answer-1').on("click", checkAnswer);
    $('text-answer-2').on("click", checkAnswer);
    $('text-answer-3').on("click", checkAnswer);
    $('text-answer-4').on("click", checkAnswer);
 ...
 function startGame(){
    ...
    $('#text-answer-2').text(questions[questionNumber].a1);
    $('#text-answer-3').text(questions[questionNumber].a2);
    $('#text-answer-4').text(questions[questionNumber].a3);

 };

 function checkAnswer(answer){
    if(answer === questions[questionNumber].ca){
        correctAnswer();
    } else {
        wrongAnswer();
    }
